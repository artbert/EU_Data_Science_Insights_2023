...
EUROPEAN_COUNTRIES = [
    ...
    "Romania", "Netherlands", "Belgium", "Sweden", "Czech Republic", "Portugal",
    "Greece", "Hungary", "Austria", "Belarus", "Switzerland", "Bulgaria", "Serbia",
    "Denmark", "Finland", "Norway", "Slovakia", "Ireland", "Croatia",
    "Bosnia and Herzegovina", "Moldova", "Lithuania", "Albania", "Slovenia",
    "Latvia", "North Macedonia", "Estonia", "Luxembourg", "Montenegro", "Malta",
